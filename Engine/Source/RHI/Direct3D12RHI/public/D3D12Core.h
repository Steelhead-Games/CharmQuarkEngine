...
namespace cqe
{
	namespace Render::RHI
	{
		...
		DIRECT3D_API std::string GetShaderTarget(const Technique::ShaderInfoDescription::ShaderType& shaderType);
		DIRECT3D_API D3D12_INPUT_CLASSIFICATION ConvertToD3D12InputClassification(const Technique::InputLayoutDescription::Classification& classification);
