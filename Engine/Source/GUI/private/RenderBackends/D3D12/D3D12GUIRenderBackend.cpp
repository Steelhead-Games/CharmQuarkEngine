...
namespace cqe::GUI
{
	...
	void D3D12RenderBackend::Init(Render::RHI::Context::Ptr rhiContext)
	{
		...
		init_info.RTVFormat = Render::RHI::ConvertToDXGIFormat(d3d12RHI->GetSwapChain()->GetCurrentBackBuffer()->GetFormat());
